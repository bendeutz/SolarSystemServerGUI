...
public class Test {
    ...
    public static void main(String[] args) {
        String test = "128.255.192.168";
        byte[] test2 = {(byte)128, (byte)255, (byte)192, (byte)168};
        System.out.println("Ausgang: " + Arrays.toString(test2));
        try {
            InetAddress ia = InetAddress.getByAddress(test2);
            System.out.println("Test: " + ia.getHostName());
